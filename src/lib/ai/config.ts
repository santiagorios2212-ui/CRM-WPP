...
interface AiConfigRow {
  ...
  auto_reply_reset_minutes: number
  embeddings_api_key: string | null
}

const CONFIG_COLUMNS =
  'provider, model, api_key, system_prompt, is_active, auto_reply_enabled, auto_reply_max_per_conversation, auto_reply_reset_minutes, embeddings_api_key'
...
export async function loadAiConfig(
  ...
  return {
    ...
    autoReplyResetMinutes: row.auto_reply_reset_minutes,
    embeddingsApiKey,
  }
}
